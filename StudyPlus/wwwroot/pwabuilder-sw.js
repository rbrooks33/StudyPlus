...
const CACHE = "cachev111";
const precacheFiles = [
  /* Add an array of files to precache for your app */
];

self.addEventListener("install", function (event) {
  console.log("Study Plus Install Event processing");

    console.log("Study Plus Skip waiting on install");
  self.skipWaiting();

  event.waitUntil(
    caches.open(CACHE).then(function (cache) {
        console.log("Study Plus Caching pages during install");
...
self.addEventListener("activate", function (event) {
    console.log("Study Plus Claiming clients for current page");
